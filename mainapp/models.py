...
class LNobject(models.Model):
    ...
    signal = models.ForeignKey(Signals, on_delete=models.CASCADE, verbose_name='Сигнал', null=True)
    status = models.ForeignKey(Statuses, on_delete=models.CASCADE, verbose_name='Статус сигнала', blank=True, null=True)
    clue_attr = models.ForeignKey(ClueAttrs, on_delete=models.CASCADE, verbose_name='Значащий атрибут')
